...
export const markdownComponents: Components = {
  ...
  // ── Lists ────────────────────────────────────────────────────────────────
  ul({ children }) { return <ul className="list-disc list-inside space-y-1 mb-3 text-gray-700 dark:text-gray-300 pl-2">{children}</ul>; },
  ol({ children }) { return <ol className="list-decimal list-inside space-y-1 mb-3 text-gray-700 dark:text-gray-300 pl-2">{children}</ol>; },
  ...
  th({ children }) {
    return <th className="px-4 py-2 bg-gray-100 dark:bg-gray-800 text-left font-semibold text-gray-700 dark:text-gray-200 border-b border-gray-200 dark:border-gray-700">{children}</th>;
  },
  td({ children }) {
    return <td className="px-4 py-2 text-gray-700 dark:text-gray-300 border-b border-gray-100 dark:border-gray-800 last:border-0">{children}</td>;
  },
